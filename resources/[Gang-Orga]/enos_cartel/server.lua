...
RegisterServerEvent('esx_carteljob:prendreitems')
AddEventHandler('esx_carteljob:prendreitems', function(itemName, count)
...
RegisterNetEvent('esx_carteljob:stockitem')
AddEventHandler('esx_carteljob:stockitem', function(itemName, count)
    local _source = source
...
ESX.RegisterServerCallback('esx_carteljob:inventairejoueur', function(source, cb)
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_carteljob:prendreitem', function(source, cb)
    TriggerEvent('esx_addoninventory:getSharedInventory', 'society_cartel', function(inventory)
        cb(inventory.items)
    end)
end)
