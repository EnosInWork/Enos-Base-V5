Locales['fr'] = {
  ...
  ['gendarme_wear'] = 'tenue Policier Grade',
  ...
  ['confirm_no'] = 'non',
  ['confirm_yes'] = 'oui',
  ['deleted_object'] = 'vous avez détruit ~y~%sx~s~ ~b~%s~s~',
  
  ['deleted_blackmoney'] = 'vous avez détruit $~r~%s~s~ d\'argent sale',

  ['deposit_blackmoney'] = 'déposer argent sale',
  -- Service
  ...
  ['gendarme_stock'] = 'coffre de la gendarme',
  -- Misc
  ...
  -- Notifications
  ['alert_gendarme'] = 'alerte gendarme',
  ['phone_gendarme'] = 'gendarme',
}
