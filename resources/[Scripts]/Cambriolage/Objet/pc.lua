        ...
        RMenu.Add("pc", "script_main", RageUI.CreateMenu("Cambriolage","Cambriolage"))
            ...
            RageUI.ButtonWithStyle("Prendre l'objet", nil, {RightLabel = "Récompense : ~g~2000$"}, not cooldown,function(h,a,s)
                if s then
                   ...
                   Citizen.SetTimeout(300000,function()
                    ...
                    ESX.ShowAdvancedNotification("Cambriolage ", "~r~Cambriolage !","Tu a récupéré ~g~2000$~s~" , "CHAR_LESTER_DEATHWISH", 24,5)
                end
            end)
