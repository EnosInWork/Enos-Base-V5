...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Enlever.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Pour ~g~Activé~s~ la Radio.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ ou ~" .. radioConfig.Controls.Increase.Name .. "~ Changer de fréquence~n~~" .. radioConfig.Controls.Input.Name .. "~ Choisir la fréquence~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ pour ~a~ clics micro~n~Frequency: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Enlever.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Pour ~r~Désactivé~s~ la Radio.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ Pour parler.~n~Frequency: ~1~ MHz" },
	{ "FRZL_RADIO_INPUT", "Entrer le Fréquence" },
}
Radio.Commands = {
	{
		Enabled = true, -- Add a command to be able to open/close the radio
		Name = "radio", -- Command name
		Help = "Activé la main sur la radio", -- Command help shown in chatbox when typing the command
		Params = {},
	...
	},
	{
		...
		Help = "Changer fréquence radio", -- Command help shown in chatbox when typing the command
		Params = {
			{name = "number", "Entrez la fréquence"}
		},
		Handler = function(src, args, raw)
			if Radio.Has then
				if args[1] then
